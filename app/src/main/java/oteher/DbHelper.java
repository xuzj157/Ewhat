...
public class DbHelper extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        final String CREATE_TABLE_SQL = "create table food(id integer primary key autoincrement ,food_name, kind integer)";

        final String INSERT_FOOD_SQL_BREAKFAST = "insert into food values " +
        ...
        final String INSERT_FOOD_SQL_LUNCH = "insert into food values " +
        ...
        final String INSERT_FOOD_SQL_DINNER = "insert into food values " +
        ...
        db.execSQL(INSERT_FOOD_SQL_DINNER);
